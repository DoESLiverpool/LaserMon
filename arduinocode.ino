...
char sensorId1[] = "Laserstemperature";
char sensorId2[] = "Smallasercurrent";
char sensorId3[] = "Biglasercurrent";
String stringId1("smallaser");
String stringId2("biglaser");
